...
class _$_Movie implements _Movie {
  ...
  @override
  String toString() {
    return 'Movie(title: $title, backdrop_path: $backdrop_path, id: $id, overview: $overview, poster_path: $poster_path, release_date: $release_date, vote_average: $vote_average)';
  }
